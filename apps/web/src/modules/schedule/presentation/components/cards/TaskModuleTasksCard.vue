  ...
  <v-card class="module-task-card" elevation="2">
    <v-card-title class="d-flex align-center justify-space-between pa-4">
      <div class="d-flex align-center">
        <v-avatar color="success" size="40" class="mr-3" variant="tonal">
          <v-icon color="success">mdi-format-list-checks</v-icon>
        </v-avatar>
        <div>
          <h3 class="text-h6 font-weight-bold">任务模块任务</h3>
          <p class="text-caption text-medium-emphasis mb-0">Task Module Tasks</p>
        </div>
      </div>
    ...
    <v-card-text class="pa-4">
      ...
      <div v-else class="text-center py-8">
        <v-icon size="64" color="grey-lighten-1">mdi-format-list-checkbox</v-icon>
        <p class="text-body-2 text-medium-emphasis mt-4 mb-0">暂无任务模块任务</p>
      </div>
    </v-card-text>
  </v-card>
</template>
