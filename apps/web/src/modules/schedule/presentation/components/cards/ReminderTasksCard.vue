  ...
  <v-card class="module-task-card" elevation="2">
    <v-card-title class="d-flex align-center justify-space-between pa-4">
      <div class="d-flex align-center">
        ...
        <div>
          <h3 class="text-h6 font-weight-bold">提醒模块任务</h3>
          <p class="text-caption text-medium-emphasis mb-0">Reminder Module Tasks</p>
        </div>
      </div>
    ...
    <v-card-text class="pa-4">
      ...
      <div v-else class="text-center py-8">
        ...
        <p class="text-body-2 text-medium-emphasis mt-4 mb-0">暂无提醒模块任务</p>
      </div>
    </v-card-text>
  </v-card>
</template>
