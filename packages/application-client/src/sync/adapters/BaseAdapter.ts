 ...
 * @module @dailyuse/application-client/sync/adapters
 */

import type { ISyncAdapter } from '../interfaces/ISyncAdapter';
import type {
  AdapterCredentials,
  EncryptedSyncData,
  HealthStatus,
...
import { EncryptionService, type EncryptedData } from '@dailyuse/infrastructure-client';
